# Formulaire -- Probabilites

> Imprimez ceci et etudiez-le. Vous n'aurez pas acces aux formules pendant l'examen.
...
**Loi des grands nombres** : $\bar{X}_n \to \mu$ quand $n \to \infty$ (requiert $E[X]$ finie)
...
$$S^2 = \frac{1}{n}\sum(X_i - \bar{X})^2 \qquad E[S^2] = \frac{n-1}{n}\sigma^2 \quad (\text{biaise !})$$
...
- **Methode IC** : Rejeter $H_0$ si la statistique observee $\notin$ region d'acceptation
- **Methode p-valeur** : Rejeter $H_0$ si p-valeur $\lt \alpha$
...
**Vecteur gaussien** : Toutes les combinaisons lineaires des composantes sont normales. Composantes independantes ssi $\Sigma$ diagonale.
