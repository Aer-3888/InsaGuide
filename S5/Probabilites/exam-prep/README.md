...
- See [formula-sheet.md](formula-sheet.md) for the complete formula reference
- See [distribution-recognition.md](distribution-recognition.md) for quick distribution identification
