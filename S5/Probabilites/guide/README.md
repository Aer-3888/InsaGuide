...
|---|---------|------------|------|
| 1 | [Probability Foundations](01-probability-foundations.md) | Sample spaces, axioms, conditional probability, Bayes | `01-probability-foundations.md` |
| 2 | [Discrete Random Variables](02-discrete-random-variables.md) | PMF, CDF, Bernoulli, Binomial, Poisson, Geometric | `02-discrete-random-variables.md` |
| 3 | [Continuous Random Variables](03-continuous-random-variables.md) | PDF, CDF, Uniform, Exponential, Normal, Gamma | `03-continuous-random-variables.md` |
| 4 | [Limit Theorems](04-limit-theorems.md) | Law of Large Numbers, Central Limit Theorem, Chebyshev | `04-limit-theorems.md` |
| 5 | [Confidence Intervals](05-confidence-intervals.md) | Mean CI, Variance CI, Proportion CI, Chi-squared, Student | `05-confidence-intervals.md` |
| 6 | [Hypothesis Testing](06-hypothesis-testing.md) | Conformity, Homogeneity, p-value, Power analysis | `06-hypothesis-testing.md` |
| 7 | [Joint Distributions and Random Vectors](07-joint-distributions.md) | Joint/Marginal/Conditional, Multinomial, Gaussian vectors | `07-joint-distributions.md` |
| 8 | [R Programming for Statistics](08-r-programming.md) | Syntax, distributions, plotting, statistical functions | `08-r-programming.md` |
