...
test_add1_3 :-
    assert_true( countall(_, test_add1_3_aux, 8) ).
test_add1_3_aux :-
...
test_add1_4 :-
    assert_true( countall(_, test_add1_4_aux, 8) ).
test_add1_4_aux :-
    (X = zero; X = s(zero); X = s(s(zero)); X = s(s(s(zero))); X = s(s(s(s(zero))));
     X = s(s(s(s(s(zero))))); X = s(s(s(s(s(zero))))); X = s(s(s(s(s(s(zero))))))),
...
test_add1_5 :-
    assert_true( countall(_, test_add1_5_aux, 64) ).
test_add1_5_aux :-
    (X = zero; X = s(zero); X = s(s(zero)); X = s(s(s(zero))); X = s(s(s(s(zero))));
     X = s(s(s(s(s(zero))))); X = s(s(s(s(s(zero))))); X = s(s(s(s(s(s(zero))))))),
...
test_sub1_1 :-
    assert_true( countall(_, test_sub1_1_aux, 8) ).
test_sub1_1_aux :-
    (X = zero; X = s(zero); X = s(s(zero)); X = s(s(s(zero))); X = s(s(s(s(zero))));
     X = s(s(s(s(s(zero))))); X = s(s(s(s(s(zero))))); X = s(s(s(s(s(s(zero))))))),
    sub1(X, X, zero).
...
test_sub1_2 :-
    assert_true( countall(_, test_sub1_2_aux, 15) ).
test_sub1_2_aux :-
...
test_sub1_3 :-
    assert_true( countall(_, test_sub1_3_aux, 64) ).
test_sub1_3_aux :-
    (X = zero; X = s(zero); X = s(s(zero)); X = s(s(s(zero))); X = s(s(s(s(zero))));
     X = s(s(s(s(s(zero))))); X = s(s(s(s(s(zero))))); X = s(s(s(s(s(s(zero))))))),
    (Y = zero; Y = s(zero); Y = s(s(zero)); Y = s(s(s(zero))); Y = s(s(s(s(zero))));
...
test_prod1_2 :-
    assert_true( countall(_, test_prod1_2_aux, 8) ).
test_prod1_2_aux :-
    (X = zero; X = s(zero); X = s(s(zero)); X = s(s(s(zero))); X = s(s(s(s(zero))));
     X = s(s(s(s(s(zero))))); X = s(s(s(s(s(zero))))); X = s(s(s(s(s(s(zero))))))),
    prod1(zero, X, zero).
...
test_prod1_3 :-
    assert_true( countall(_, test_prod1_3_aux, 8) ).
test_prod1_3_aux :-
    (X = zero; X = s(zero); X = s(s(zero)); X = s(s(s(zero))); X = s(s(s(s(zero))));
     X = s(s(s(s(s(zero))))); X = s(s(s(s(s(zero))))); X = s(s(s(s(s(s(zero))))))),
...
test_prod1_4 :-
    assert_true( countall(_, test_prod1_4_aux, 8) ).
test_prod1_4_aux :-
    (X = zero; X = s(zero); X = s(s(zero)); X = s(s(s(zero))); X = s(s(s(s(zero))));
     X = s(s(s(s(s(zero))))); X = s(s(s(s(s(zero))))); X = s(s(s(s(s(s(zero))))))),
    prod1(X, s(zero), X).
...
test_prod1_5 :-
    assert_true( countall(_, test_prod1_5_aux, 64) ).
test_prod1_5_aux :-
    (X = zero; X = s(zero); X = s(s(zero)); X = s(s(s(zero))); X = s(s(s(s(zero))));
     X = s(s(s(s(s(zero))))); X = s(s(s(s(s(zero))))); X = s(s(s(s(s(s(zero))))))),
    (Y = zero; Y = s(zero); Y = s(s(zero)); Y = s(s(s(zero))); Y = s(s(s(s(zero))));
