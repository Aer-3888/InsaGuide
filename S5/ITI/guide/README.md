...
| Section | Purpose |
|---------|---------|
| [Shell & Bash](shell-bash.md) | Commands, piping, scripting -- the backbone of the FUS exam |
| [Regular Expressions](regex.md) | Syntax, patterns, grep/sed/awk -- exam staple |
| [Build Tools](build-tools.md) | Make, gcc, compilation pipeline |
| [Debugging](debugging.md) | gdb, valgrind, profiling with gprof |
| [Git Version Control](git.md) | All git commands and workflows |
| [Python Basics](python-basics.md) | Syntax, data structures, OOP, sorting |
| [SQL & SQLite](sql-sqlite.md) | Queries, joins, Python integration |
| [Qt GUI Programming](qt-gui.md) | PyQt5 widgets, signals/slots, image processing |
| [Web Scraping](web-scraping.md) | BeautifulSoup, HTML parsing, automation |
