...
> D'apres les instructions du TP : `data/moodle/tp/tp5/README.md`
...
(* Trouver l'indice, retourne 0 si absent *)
...
(* Type option pour une recherche sure *)
type 'a option = None | Some of 'a

(* Trouver l'indice sous forme d'option *)
