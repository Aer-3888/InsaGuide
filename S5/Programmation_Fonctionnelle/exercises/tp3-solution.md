# TP3 - Jeu de cartes avec types et graphiques

> D'apres les instructions du TP : `data/moodle/tp/tp3/README.md`
...
(* Creer une carte a partir d'un entier et d'une chaine *)
...
(* Creer un jeu de n cartes uniques, chacune formant une pile *)
let rec faitjeu n =
...
Regles : on examine les piles 3 par 3 (A, B, C). Si la carte au sommet de A et la carte au sommet de C ont la meme couleur ou la meme hauteur, la pile B est placee sur A (B @ A), et les 3 piles deviennent 2.
...
(* Appliquer les reductions jusqu'a point fixe *)
let rec reussite l =
  let l' = reduc l in
...
### Affichage des cartes avec le module Graphics
...
Cet exercice consiste a dessiner des sprites de cartes et a implementer un affichage interactif du jeu. Voir le code source original du TP pour le code graphique complet.
