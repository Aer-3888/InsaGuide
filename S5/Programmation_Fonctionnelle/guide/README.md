...
| Fichier | Sujet |
|---------|-------|
| [01-ocaml-basics.md](01-ocaml-basics.md) | Bases OCaml : let, types, inference, tuples, records |
| [02-pattern-matching.md](02-pattern-matching.md) | Pattern matching : match, wildcards, exhaustivite |
| [03-recursion.md](03-recursion.md) | Recursion : recursive, terminale, accumulateurs |
| [04-higher-order-functions.md](04-higher-order-functions.md) | Fonctions d'ordre superieur : map, fold, filter, curryfication |
| [05-algebraic-data-types.md](05-algebraic-data-types.md) | Types algebriques : variants, option, polymorphisme |
| [06-lists-and-trees.md](06-lists-and-trees.md) | Listes et arbres : operations, parcours, ABR |
| [07-modules-and-functors.md](07-modules-and-functors.md) | Modules et foncteurs : signatures, implementations |
| [08-imperative-features.md](08-imperative-features.md) | Traits imperatifs : refs, tableaux, boucles |
