...
> D'apres les instructions du TP : S6/Bases_de_Donnees/data/moodle/tp/tp4_mongodb/sujet.pdf
...
**Explication :**
`services.0` accede au premier element du tableau (index 0). C'est la dot notation appliquee aux tableaux. Reference : https://docs.mongodb.com/manual/tutorial/query-arrays/
...
### Mise en place : Creation de l'index et recuperation des coordonnees
