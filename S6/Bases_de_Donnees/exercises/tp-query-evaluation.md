# TP1 - Evaluation de Requetes

> D'apres les instructions du TP : S6/Bases_de_Donnees/data/moodle/tp/tp1_query_evaluation/README.md
> Fichiers SQL source : 01_basic_queries.sql, 02_create_tables.sql, 03_index_analysis.sql, 04_query_optimization.sql
...
## Partie 2 : Base de donnees importante et indexation (Section 7.2.2)
