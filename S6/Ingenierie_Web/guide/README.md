...
|---|----------|---------|-------------|
| 1 | HTTP et fondamentaux Web | [01_http_web_fundamentals.md](01_http_web_fundamentals.md) | HTTP, REST, URL, client-serveur |
| 2 | HTML et CSS | [02_html_css.md](02_html_css.md) | Structure HTML, CSS, Flexbox, Grid |
| 3 | JavaScript ES6+ | [03_javascript.md](03_javascript.md) | Types, fonctions, classes, async, fetch |
| 4 | Java Servlets et Spring Boot | [04_java_spring_boot.md](04_java_spring_boot.md) | Routes REST, DTO, services, tests |
| 5 | ORM et JPA | [05_orm_jpa.md](05_orm_jpa.md) | Entites, relations, repositories |
| 6 | XML et JSON | [06_xml_json.md](06_xml_json.md) | Formats de donnees, schemas, marshalling |
| 7 | Securite Web | [07_web_security.md](07_web_security.md) | XSS, CSRF, authentification, sessions |
| 8 | Angular et TypeScript | [08_angular_typescript.md](08_angular_typescript.md) | Composants, data binding, HttpClient |
