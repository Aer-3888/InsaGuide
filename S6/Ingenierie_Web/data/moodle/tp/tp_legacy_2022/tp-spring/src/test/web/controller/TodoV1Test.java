...
class TodoV1Test {
    ...
    void TestGetTodo() throws Exception{
        mvc.perform(get("http://localhost:8080/api/insa/v1/todo/Todo"))
    ...
    void TestPostTodo() throws Exception{
        mvc.perform(
                post("http://localhost:8080/api/insa/v1/todo/TodoJSON")
    ...
    void TestAddTodo() throws Exception{
        mvc.perform(post("/api/insa/v1/todo/newUser")
                .contentType(MediaType.APPLICATION_JSON)
                .content("""                                
                                {
                                	"name" : "Leandre",
        ...
        mvc.perform(post("/api/insa/v1/todo/todo/Leandre/Devoir")
                .contentType(MediaType.APPLICATION_JSON)
                .content("""                                
