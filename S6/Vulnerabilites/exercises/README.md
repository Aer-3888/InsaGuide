...
|---------|-------|-----------|
| [tp1_shell_security.md](tp1_shell_security.md) | TP1 : Shell for Security -- Analyse de fichiers | Commandes shell, extraction de balises, recherche de credentials, Base64, CVSS |
| [exercices_injection_sql.md](exercices_injection_sql.md) | Injection SQL | Identification de champs, contournement de login, UNION SELECT, second ordre, CVSS |
| [exercices_xss_csrf.md](exercices_xss_csrf.md) | XSS et CSRF | XSS reflete/stocke/DOM-based, CSRF GET/POST, CSP, comparaison XSS vs CSRF, CVSS |
| [exercices_protocoles.md](exercices_protocoles.md) | Protocoles de securite | Inference de messages, secret, attaque de Lowe, challenge-response, Scyther, NSPKL |
| [exercices_cvss.md](exercices_cvss.md) | Qualification et CVSS | CIA, calcul CVSS v3.1, comparaison versions, IoT, Log4Shell, classement de vulnerabilites |
