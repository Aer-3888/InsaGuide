...
|---------|-------|-------------|
| [01_fondamentaux_securite.md](01_fondamentaux_securite.md) | CIA, CVE, CVSS, modeles d'attaquant | Triade CIA, Dolev-Yao, Kerckhoffs |
| [02_vulnerabilites_memoire.md](02_vulnerabilites_memoire.md) | Buffer overflows, format strings, integer overflows | Stack/heap, exploitation, prevention |
| [03_injection_sql.md](03_injection_sql.md) | SQL injection : mecanisme, variantes, protections | OR 1=1, UNION, requetes preparees |
| [04_xss_csrf.md](04_xss_csrf.md) | XSS reflete/stocke/DOM, CSRF | CSP, HttpOnly, tokens anti-CSRF |
| [05_injection_commandes.md](05_injection_commandes.md) | Injection OS, reverse shells, ShellShock | Separateurs, whitelist, regex |
| [06_techniques_exploitation.md](06_techniques_exploitation.md) | Shellcode, return-to-libc, ROP, NOP sled | Contexte educatif defensif |
| [07_mecanismes_defense.md](07_mecanismes_defense.md) | ASLR, DEP/NX, canaries, RELRO, PIE, CFI | Defense en profondeur |
| [08_vulnerabilites_web.md](08_vulnerabilites_web.md) | SSRF, path traversal, OWASP Top 10 | Classification, prevention |
| [09_authentification_sessions.md](09_authentification_sessions.md) | Password cracking, stockage securise, MFA | hashcat, sel, hierarchie d'authentification |
| [10_cryptographie_protocoles.md](10_cryptographie_protocoles.md) | Sym/asym, hachage, signatures, PKI | Notations, inference, hypothese crypto parfaite |
| [11_securite_reseau.md](11_securite_reseau.md) | Sniffing, ARP spoofing, DNS poisoning, TLS | Protocoles, attaques, contre-mesures |
| [12_man_in_the_middle.md](12_man_in_the_middle.md) | NSPK, attaque de Lowe, NSPKL | Sessions paralleles, verification Scyther |
| [13_securite_systeme.md](13_securite_systeme.md) | Privileges, permissions, sandboxing | PwnKit, conteneurs, moindre privilege |
| [14_securite_cloud.md](14_securite_cloud.md) | IaaS/PaaS/SaaS, multitenancy, canaux auxiliaires | Deduplication, IAM, images |
| [15_developpement_securise.md](15_developpement_securise.md) | Validation, encodage, OWASP, moindre privilege | Secure coding, revue de code |
| [cheat_sheet.md](cheat_sheet.md) | Fiche de revision rapide pour le DS | Tout en une page |
