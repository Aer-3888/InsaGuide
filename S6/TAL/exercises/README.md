...
|---------|---------|-----------|
| [01_viterbi_traces.md](01_viterbi_traces.md) | Traces completes de l'algorithme de Viterbi | 3 etats/3 mots, ambiguite, 4 etats, estimation de parametres HMM |
| [02_cky_traces.md](02_cky_traces.md) | Traces completes de l'algorithme CKY et PCFG | CKY 5 mots, CKY avec PP, PCFG 2 arbres, CNF, ambiguite d'attachement PP |
| [03_naive_bayes_calculs.md](03_naive_bayes_calculs.md) | Calculs Naive Bayes avec lissage de Laplace | Classification sentiment, TF-IDF + cosinus, Laplace, prior desequilibre, binaire vs frequentiel |
| [04_tfidf_calculs.md](04_tfidf_calculs.md) | TF-IDF, cosinus, BM25, evaluation | TF-IDF complet, IDF, booleen vs vectoriel, BM25, MAP, nDCG, PageRank, index inverse |
| [05_ngram_perplexite.md](05_ngram_perplexite.md) | N-grammes et perplexite | Bigramme ML, perplexite, Laplace, interpolation, perplexite comparative, trigramme |
| [06_transition_parser.md](06_transition_parser.md) | Traces du parser transition-based | 4 phrases completes, Left-Arc vs Right-Arc, relations UD, UAS/LAS |
