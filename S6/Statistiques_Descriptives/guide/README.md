...
|---|----------|-------------|
| 01 | [Statistiques descriptives](01_descriptive_statistics.md) | Moyenne, mediane, variance, ecart-type, quartiles, boxplots -- decrire les donnees. |
| 02 | [Estimation statistique](02_statistical_estimation.md) | Estimer une valeur inconnue a partir d'un echantillon -- IC, MLE, methode des moments. |
| 03 | [Tests d'hypothese](03_hypothesis_testing.md) | H0/H1, p-value, erreurs de type I/II, puissance d'un test. |
| 04 | [Tests courants](04_common_tests.md) | t-test, chi-deux, F-test, Z-test, tests apparies -- le catalogue. |
| 05 | [Regression lineaire](05_linear_regression.md) | Regression simple et multiple, R2, residus, selection de variables. |
| 06 | [ANOVA](06_anova.md) | ANOVA a 1 et 2 facteurs, F-statistic, Tukey HSD, hypotheses. |
| 07 | [Tests non parametriques](07_nonparametric_tests.md) | Wilcoxon, Mann-Whitney, Kruskal-Wallis -- quand la normalite manque. |
| 08 | [Programmation R](08_r_programming.md) | Data frames, import, graphiques, distributions, fonctions statistiques. |
