...
| Document | Contenu |
|----------|---------|
| [Arbre de decision des tests](decision_tree.md) | Le flowchart complet "quel test utiliser ?" |
| [Formulaire](formula_sheet.md) | Toutes les formules du cours organisees par theme |
