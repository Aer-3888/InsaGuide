...
|---|----------|-------------|
| 01 | [Fondamentaux des graphes](01_graph_fundamentals.md) | Sommets, aretes, arcs, degres, representations (matrice/liste), graphes ponderes, types speciaux. |
| 02 | [Parcours de graphes](02_graph_traversals.md) | BFS, DFS, proprietes, applications, composantes connexes, forte connexite. |
| 03 | [Plus courts chemins](03_shortest_paths.md) | Dijkstra, Bellman-Ford, Floyd-Warshall, poids negatifs, circuits absorbants. |
| 04 | [Arbres couvrants minimaux](04_minimum_spanning_trees.md) | Kruskal, Prim, propriete de coupe, propriete de cycle. |
| 05 | [Flots et reseaux](05_network_flow.md) | Ford-Fulkerson, theoreme flot max / coupe min, couplage biparti. |
| 06 | [Euler et Hamilton](06_euler_hamilton.md) | Cycles/chaines euleriens, chemins hamiltoniens, conditions, theoremes. |
| 07 | [Coloration de graphes](07_graph_coloring.md) | Nombre chromatique, algorithme glouton, DSatur, theoremes de Brooks et des 4 couleurs. |
| 08 | [Planarite](08_planarity.md) | Graphes planaires, formule d'Euler, theoreme de Kuratowski, K5, K3,3. |
| 09 | [Arbres et forets](09_trees_forests.md) | Arbres couvrants, arbres enracines, forets, proprietes fondamentales, tri topologique. |
