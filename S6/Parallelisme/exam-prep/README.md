...
| Fichier | Contenu |
|---------|---------|
| [questions_cours.md](questions_cours.md) | Questions de cours recurrentes avec reponses |
| [exercices_type.md](exercices_type.md) | Exercices types avec solutions detaillees |
| [pieges_frequents.md](pieges_frequents.md) | Erreurs classiques a l'examen et comment les eviter |
