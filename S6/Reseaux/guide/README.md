...
|---|----------|-------------|
| 01 | [Modele OSI & TCP/IP](01_modele_osi_tcpip.md) | Architecture en couches, encapsulation, protocoles par couche |
| 02 | [Couche physique & liaison](02_physique_liaison.md) | Ethernet, adresses MAC, ARP, switching, VLANs, CSMA/CD |
| 03 | [Couche reseau (IP)](03_couche_reseau_ip.md) | IPv4, IPv6, sous-reseaux, CIDR, tables de routage, NAT, fragmentation |
| 04 | [Couche transport](04_couche_transport.md) | TCP (3-way handshake, controle de flux, congestion), UDP, ports |
| 05 | [Couche application](05_couche_application.md) | DNS, HTTP, SMTP, FTP, DHCP |
| 06 | [Programmation socket en C](06_programmation_socket.md) | API POSIX, client-serveur TCP/UDP, select/poll, multicast |
| 07 | [Protocoles de routage](07_protocoles_routage.md) | Vecteur de distance (RIP), etat de liens (OSPF), BGP |
| 08 | [Securite reseau](08_securite_reseau.md) | Firewalls, TLS/SSL, VPN, filtrage de paquets |
